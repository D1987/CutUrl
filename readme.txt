...
Использовано обычное подключение JDBC к бд, разработка велась также с использованием Hibernate однако в силу медленной
скорости здесь представлено обычное подключение.
